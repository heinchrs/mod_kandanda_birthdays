...
class Mod_Kandanda_BirthdaysInstallerScript
{
	/**
	...
	private function getChangelog()
	{
		...
		$title1 = JText::sprintf('MOD_KANDANDA_BIRTHDAYS_EXTENSION_INSTALLED', JText::_($this->name), $thisVersion);
		$title2 = JText::_('MOD_KANDANDA_BIRTHDAYS_LATEST_CHANGES');
